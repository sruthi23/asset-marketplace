...
class Main extends React.Component {
  ...
  async setAssetArray() {
    ...
    assetArray = assetArray.map(index => (
      <ArtPiece assetId={index} key={index} />
    ));
  ...
  async displayBlueprint() {
    ...
    const asset = {
      ...
      image:
        "https://upload.wikimedia.org/wikipedia/commons/a/a3/Taran_Lighthouse_Kalinigrad_Oblast_Tatiana_Yagunova_Watercolor_painting.jpg",
  ...
  render() {
    return (
      <div className="art-container">
        <img
          className="art-image"
          src="https://upload.wikimedia.org/wikipedia/commons/a/a3/Taran_Lighthouse_Kalinigrad_Oblast_Tatiana_Yagunova_Watercolor_painting.jpg"
          width="300px"
        />
